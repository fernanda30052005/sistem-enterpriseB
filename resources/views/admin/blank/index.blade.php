            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <a href="{{ route('departements.index') }}" class="btn btn-primary">Lihat Departemen</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <a href="{{ route('payrolls.index') }}" class="btn btn-primary">Kelola Payroll</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <a href="{{ route('leaves.index') }}" class="btn btn-primary">Lihat Permintaan Izin</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <a href="{{ route('attendances.index') }}" class="btn btn-primary">Lihat Kehadiran</a>
                    </div>
                </div>
            </div>
        </div>
